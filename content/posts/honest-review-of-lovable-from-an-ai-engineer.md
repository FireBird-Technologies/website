...
2. **Automatic DB schema:** Instead of manually adding tables into supabase, I would love that it if it could generate a “reasonable” schema for the project. Funnily enough, I made something that does so [here](https://www.firebird-technologies.com/p/building-sql-trainer-ais-backend).
